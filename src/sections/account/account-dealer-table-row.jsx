...
export function AccountDealerTableRow({ row, selected, onSelectRow, onEditRow }) {
  ...
  return (
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.dealer_code || '-'}</TableCell>

        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.owner_name || '-'}</TableCell>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.dealer_supply_type_name || '-'}</TableCell>

        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.city || '-'}</TableCell>

        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row.gst_number || '-'}</TableCell>
