...
import { MakingChargeFormModal } from './making-charge-form-modal';
import { MakingChargeTableRow } from './making-charge-table-row';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'charge_name', label: 'Charge Name', width: 200 },
  { id: 'charge_code', label: 'Charge Code', width: 120 },
  { id: 'labour_charge', label: 'Charge Type', width: 130 },
  { id: 'charge_value', label: 'Charge Value', width: 120 },
...
export default function MakingChargesView() {
