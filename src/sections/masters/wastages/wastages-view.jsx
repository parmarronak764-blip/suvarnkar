...
import { useWastages } from 'src/hooks/useWastages';
import { WastageFormModal } from './wastage-form-modal';
import { WastageTableRow } from './wastage-table-row';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'wastage_code', label: 'Wastage Code', width: 150 },
  { id: 'charge_type', label: 'Charge Type', width: 120 },
  { id: 'wastage_percentage', label: 'Wastage %', width: 120 },
...
export default function WastagesView() {
      ...
      try {
        ...
        if (response.success) {
          if (currentItem) {
            ...
            toast.success('Wastage created successfully!');
          }
          return response;
        } else {
          return response;
